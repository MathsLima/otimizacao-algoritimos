...
3. Resolva o problema da mochila conforme o enuciado em sala de aula. 
   ...
   a. Ache uma solução que testa todas as combinações possíveis e seleciona a melhor, aplicando divisão-e-conquista ou não;
   b. Contabilize o número de iterações;
   c. Implemente e teste sua solução, para o caso exposto em aula e outros de mesmo porte (;-)).
